...
!function (e, t) {
  ...
  var q = {
    ...
    if (o = e, i = t, a(o.classList).forEach(function (e) {
      ...
      if ("string" != typeof t.customClass[n] && !t.customClass[n].forEach) return s("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(_typeof(t.customClass[n]), '"'));
      W(e, t.customClass[n]);
    }
  },
      F = function F(e, t) {
    ...
    if (oe()) r("SweetAlert2 requires document to initialize");else {
      ...
      re = function re(e, t) {
    e instanceof HTMLElement ? t.appendChild(e) : "object" == _typeof(e) ? ce(e, t) : e && V(t, e);
  },
      ce = function ce(e, t) {
  ...
  ke.text = ke.email = ke.password = ke.number = ke.tel = ke.url = function (e, t) {
    return "string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : p(t.inputValue) || s('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(_typeof(t.inputValue), '"')), we(e, e, t), ve(e, t), e.type = t.input, e;
  ...
  var Ae = function Ae(e, t) {
    ...
    if (t.iconColor) {
      ...
      for (var _i2 = 0, _arr = [".swal2-success-line-tip", ".swal2-success-line-long", ".swal2-x-mark-line-left", ".swal2-x-mark-line-right"]; _i2 < _arr.length; _i2++) {
        var _n8 = _arr[_i2];
        X(e, _n8, "backgroundColor", t.iconColor);
      }
  ...
  var Je = Object.freeze({
    ...
    argsToParams: function argsToParams(n) {
      var o = {};
      return "object" != _typeof(n[0]) || m(n[0]) ? ["title", "html", "icon"].forEach(function (e, t) {
        t = n[t];
        "string" == typeof t || m(t) ? o[e] = t : void 0 !== t && r("Unexpected type of ".concat(e, '! Expected "string" or "Element", got ').concat(_typeof(t)));
  ...
  function Xe() {
    ...
    if (e) {
      var _t2 = he.domCache.get(this);

      J(_t2.loader), H() ? e.icon && Z(w()) : function (e) {
      ...
      }(_t2), _([_t2.popup, _t2.actions], h.loading), _t2.popup.removeAttribute("aria-busy"), _t2.popup.removeAttribute("data-loading"), _t2.confirmButton.disabled = !1, _t2.denyButton.disabled = !1, _t2.cancelButton.disabled = !1;
    }
  }
  ...
  function lt(e, t) {
    ...
    if ("radio" === e.type) {
      var _n9 = e.parentNode.parentNode,
          _o6 = _n9.querySelectorAll("input");
  ...
  var mt = ["swal-title", "swal-html", "swal-footer"],
    ...
    return a(e.querySelectorAll("swal-param")).forEach(function (e) {
      ...
      "boolean" == typeof Re[t] && "false" === n && (n = !1), "object" == _typeof(Re[t]) && (n = JSON.parse(n)), o[t] = n;
    }), o;
  },
      bt = function bt(e) {
    var n = {};
    ...
    if (e.target === t) {
      ...
      t.removeEventListener(ue, Bt), _n10.style.overflowY = "auto";
    }
  },
      xt = function xt(e, t) {
    ...
    u(n.inputOptions) || p(n.inputOptions) ? (Me(E()), d(n.inputOptions).then(function (e) {
      t.hideLoading(), i(e);
    })) : "object" == _typeof(n.inputOptions) ? i(n.inputOptions) : r("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(_typeof(n.inputOptions)));
  },
      jt = function jt(t, n) {
    var o = t.getInput();
    ...
    return "undefined" != typeof Map && n instanceof Map ? n.forEach(function (e, t) {
      var n = e;
      "object" == _typeof(n) && (n = Dt(n)), o.push([t, n]);
    }) : Object.keys(n).forEach(function (e) {
      var t = n[e];
      "object" == _typeof(t) && (t = Dt(t)), o.push([e, t]);
    }), o;
  },
      It = function It(e, t) {
