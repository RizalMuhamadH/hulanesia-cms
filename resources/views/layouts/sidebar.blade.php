<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="{{ Request::segment(1) == 'dashboard' ? 'active' : '' }}"><a class="nav-link" href="/dashboard"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
          @can('browse_posts')
          ...
          <li class="{{ Request::segment(1) == 'categories' ? 'active' : '' }}"><a class="nav-link" href="{{ route('category.index') }}"><i class="fas fa-layer-group"></i> <span>Categories</span></a></li>
          @endcan
          @can('browse_tags')
          <li class="{{ Request::segment(1) == 'tags' ? 'active' : '' }}"><a class="nav-link" href="{{ route('tag.index') }}"><i class="fas fa-tag"></i> <span>Tags</span></a></li>
          @endcan
          @can('browse_features')
          <li class="{{ Request::segment(1) == 'features' ? 'active' : '' }}"><a class="nav-link" href="{{ route('feature.index') }}"><i class="fas fa-asterisk"></i> <span>Features</span></a></li>
          @endcan
          @can('browse_users')
          <li class="{{ Request::segment(1) == 'users' ? 'active' : '' }}"><a class="nav-link" href="{{ route('user.index') }}"><i class="fas fa-user-circle"></i> <span>Users</span></a></li>
          @endcan
          @can('browse_roles')
          <li class="{{ Request::segment(1) == 'roles' ? 'active' : '' }}"><a class="nav-link" href="{{ route('role.index') }}"><i class="fas fa-key"></i> <span>Roles</span></a></li>
          @endcan
          @can('browse_settings')
          ...
          @endcan
          @can('browse_videos')
          <li class="{{ Request::segment(1) == 'videos' ? 'active' : '' }}"><a class="nav-link" href="{{ route('video.index') }}"><i class="fab fa-youtube"></i> <span>Videos</span></a></li>
          @endcan
        </ul>
