            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ $action == 'Add' ? route('user.store') : route('user.update', $content->id ?? '') }}" method="POST">
                            @csrf
                            ...
                            @if ($action == 'Add')
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-2">Password Confirmation</label>
                                <div class="col-sm-12 col-md-7 col-lg-9">
                                    <input type="password" class="form-control" name="password_confirmation" {{ $action == 'Add' ? 'required' : '' }} >
                                </div>
                            </div>
                            @endif
