    ...
    if ($(".daterange-cus").length) {
      // document.addEventListener('livewire:load', function () {
        $('.daterange-cus').daterangepicker({
          ...
          window.Livewire.emit('getDateForInput', {start : start.format('YYYY-MM-DD'), end : end.format('YYYY-MM-DD')});
          // $wire.start = start.format('YYYY-MM-DD');
          // location.href = '?start=' + start.format('YYYY-MM-DD') + '&end=' + end.format('YYYY-MM-DD');
